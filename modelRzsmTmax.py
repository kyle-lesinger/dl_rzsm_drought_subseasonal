...
def conv_batchnorm_sigmoid_block_SE_and_residual_connections(input_tensor, nb_filter, dropout_rate, kernel_norm, kernel_size=3,kernel_initializer=kernel_initializer):
    ...
    shortcut = Activation('sigmoid')(shortcut)
...
def inception_block(prevlayer, a, b,dropout_rate, kernel_norm, depth_multiplier = False):
    ...
    conve = tf.keras.activations.sigmoid(conve)
    conve = Dropout(dropout_rate)(conve, training =True) #add dropout
...
def model_build_func(inputs,kernel_norm, output_channels,var_name, number_of_UNET_backbone_max_pool,using_deep_supervision=True,kernel_initializer=kernel_initializer ):
    ...
    conv1_2 = conv_batchnorm_sigmoid_block_SE_and_residual_connections(conv1_2, nb_filter=nb_filter[2], dropout_rate = dropout_rate_later, kernel_norm=kernel_norm)
    ...
    conv2_2 = conv_batchnorm_sigmoid_block_SE_and_residual_connections(conv2_2, nb_filter=nb_filter[2], dropout_rate = dropout_rate_later, kernel_norm=kernel_norm)
    ...
    conv1_3 = conv_batchnorm_sigmoid_block_SE_and_residual_connections(conv1_3, nb_filter=nb_filter[2], dropout_rate = dropout_rate_later, kernel_norm=kernel_norm)
    ...
    conv3_2 = conv_batchnorm_sigmoid_block_SE_and_residual_connections(conv3_2, nb_filter=nb_filter[2], dropout_rate = dropout_rate_later, kernel_norm=kernel_norm)
    ...
    # conv4_2 = conv_batchnorm_sigmoid_block_SE_and_residual_connections(conv4_2, nb_filter=nb_filter[3], dropout_rate = dropout_rate_later)
    ...
    # conv3_3 = conv_batchnorm_sigmoid_block_SE_and_residual_connections(conv3_3, nb_filter=nb_filter[2], dropout_rate = dropout_rate_later)
    ...
    # conv2_4 =  conv_batchnorm_sigmoid_block_SE_and_residual_connections(conv2_4, nb_filter=nb_filter[1], dropout_rate = dropout_rate_later)
    ...
    conv1_5 =  conv_batchnorm_sigmoid_block_SE_and_residual_connections(conv1_5, nb_filter=nb_filter[0], dropout_rate = dropout_rate_later, kernel_norm=kernel_norm)

    nestnet_output_1 = Conv2D(output_channels, (1, 1), activation='sigmoid', name=f'RZSM_output_1',padding='same',kernel_initializer=kernel_initializer)(conv1_2)
    nestnet_output_2 = Conv2D(output_channels, (1, 1), activation='sigmoid', name=f'RZSM_output_2', padding='same',kernel_initializer=kernel_initializer )(conv1_3)
    nestnet_output_3 = Conv2D(output_channels, (1, 1), activation='sigmoid', name=f'RZSM_output_3', padding='same',kernel_initializer=kernel_initializer)(conv1_4)
    nestnet_output_4 = Conv2D(output_channels, (1, 1), activation='sigmoid', name=f'RZSM_output_4', padding='same',kernel_initializer=kernel_initializer)(conv1_5)
    
    nestnet_output_5 = Conv2D(output_channels, (1, 1), activation='sigmoid', name=f'tmax_output_1',padding='same',kernel_initializer=kernel_initializer)(conv1_2)
    nestnet_output_6 = Conv2D(output_channels, (1, 1), activation='sigmoid', name=f'tmax_output_2', padding='same',kernel_initializer=kernel_initializer )(conv1_3)
    nestnet_output_7 = Conv2D(output_channels, (1, 1), activation='sigmoid', name=f'tmax_output_3', padding='same',kernel_initializer=kernel_initializer)(conv1_4)
    nestnet_output_8 = Conv2D(output_channels, (1, 1), activation='sigmoid', name=f'tmax_output_4', padding='same',kernel_initializer=kernel_initializer)(conv1_5)

    if using_deep_supervision:
        if number_of_UNET_backbone_max_pool == 3:
            return(nestnet_output_1,nestnet_output_2,nestnet_output_3,
                  nestnet_output_5,nestnet_output_6,nestnet_output_7)
        
        elif number_of_UNET_backbone_max_pool == 4:
            #With all return channels
            return(nestnet_output_1,nestnet_output_2,nestnet_output_3,nestnet_output_4,
                  nestnet_output_5,nestnet_output_6,nestnet_output_7,nestnet_output_8)
