...
def model_build_func(inputs,kernel_norm, output_channels,var_name, number_of_UNET_backbone_max_pool,using_deep_supervision=True,kernel_initializer=kernel_initializer ):
    ...
    conv3_1 = conv_batchnorm_sigmoid_block_SE_and_residual_connections(pool2, nb_filter=nb_filter[2], dropout_rate = dropout_rate_later, kernel_norm=kernel_norm)
    ...
    conv4_1 = conv_batchnorm_sigmoid_block_SE_and_residual_connections(pool3, nb_filter=nb_filter[3], dropout_rate = dropout_rate_later, kernel_norm=kernel_norm)
    ...
    #conv5_1 = conv_batchnorm_sigmoid_block_SE_and_residual_connections(pool4, nb_filter=nb_filter[2], dropout_rate = dropout_rate_later, kernel_norm =kernel_norm)
    ...
    #conv4_2 = conv_batchnorm_sigmoid_block_SE_and_residual_connections(conv4_2, nb_filter=nb_filter[2], dropout_rate = dropout_rate_later, kernel_norm =kernel_norm)
    ...
    #conv3_3 = conv_batchnorm_sigmoid_block_SE_and_residual_connections(conv3_3, nb_filter=nb_filter[2], dropout_rate = dropout_rate_later, kernel_norm=kernel_norm)
    ...
    #conv2_4 =  conv_batchnorm_sigmoid_block_SE_and_residual_connections(conv2_4, nb_filter=nb_filter[1], dropout_rate = dropout_rate_later, kernel_norm=kernel_norm)
    ...
    #nestnet_output_4 = Conv2D(output_channels, (1, 1), activation='sigmoid', name=f'RZSM_output_4', padding='same',kernel_initializer=kernel_initializer,dtype=tf.float32)(conv1_5)
