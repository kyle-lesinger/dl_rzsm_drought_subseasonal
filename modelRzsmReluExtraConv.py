...
def inception_block(prevlayer, a, b,dropout_rate, kernel_norm, depth_multiplier = False):
    ...
    conva = Conv2D(a, 3, padding='same',kernel_initializer=kernel_initializer, kernel_constraint = kernel_norm)(prevlayer)
    ...
    convb = Conv2D(a, 5, padding='same',kernel_initializer=kernel_initializer, kernel_constraint = kernel_norm)(prevlayer)
    ...
    convc = Conv2D(a, 7, padding='same',kernel_initializer=kernel_initializer, kernel_constraint = kernel_norm)(prevlayer)
...
def model_build_func(inputs,kernel_norm, output_channels,var_name, number_of_UNET_backbone_max_pool,using_deep_supervision=True,kernel_initializer=kernel_initializer ):
    ...
    conv1_1 = conv_batchnorm_relu_block_SE_and_residual_connections(conv1_1, nb_filter=nb_filter[1], dropout_rate = dropout_rate_later, kernel_norm=kernel_norm)
    ...
    conv2_1 = conv_batchnorm_relu_block_SE_and_residual_connections(conv2_1, nb_filter=nb_filter[2], dropout_rate = dropout_rate_later, kernel_norm=kernel_norm)
    ...
    conv1_2 = conv_batchnorm_relu_block_SE_and_residual_connections(conv1_2, nb_filter=nb_filter[1], dropout_rate = dropout_rate_later, kernel_norm=kernel_norm)
    ...
    conv1_4 = conv_batchnorm_relu_block_SE_and_residual_connections(conv1_4, nb_filter=nb_filter[1], dropout_rate = dropout_rate_later, kernel_norm=kernel_norm)
