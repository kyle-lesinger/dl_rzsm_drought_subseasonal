...
def model_build_func(inputs,kernel_norm, output_channels,var_name, number_of_UNET_backbone_max_pool,using_deep_supervision=True,kernel_initializer=kernel_initializer ):
    ...
    # conv2_1a = inception_block(conv2_1, nb_filter[1], nb_filter[1], dropout_rate = dropout_rate_later,depth_multiplier=True, kernel_norm =kernel_norm)
    ...
    # conv2_2a = inception_block(conv2_2, nb_filter[1], nb_filter[1], dropout_rate = dropout_rate_later,depth_multiplier=True, kernel_norm =kernel_norm)
